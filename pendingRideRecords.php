...
<h1>Book a City Texi to Your Destination in town</h1>
    ...
    <table id="tbl">
        <th>From </th>
        <th>To </th>
        <th>Ride Date <a href="pendingRideRecords.php?status=1&sort=ASC&for=ride_date"><i class="fa fa-caret-down" aria-hidden="true"></i>  </a>
        <a href="pendingRideRecords.php?status=1&sort=DESC&for=ride_date"><i class="fa fa-caret-up" aria-hidden="true"></i>  </a>
        </th>
        <th>Cab Type</th>
        <th>Total Distance</th>
        <th>Luggage (Kg)</th>
        <th>Fare<a href="pendingRideRecords.php?status=1&sort=ASC&for=total_fare"><i class="fa fa-caret-down" aria-hidden="true"></i>  </a>
        <a href="pendingRideRecords.php?status=1&sort=DESC&for=total_fare"><i class="fa fa-caret-up" aria-hidden="true"></i>  </a></th>
        <th>Status</th>
        <tbody>
            <?php 
