...
if ($data) {
 foreach ($data as $element) {
  ...
  $html .= "<td><a onClick=\"javascript: return confirm('Please confirm deletion');\" href='pastRides.php?del_id=$rideID' class='btn btn-danger'>DELETE RIDE</a></td>";
  $html .= "</tr>";
  echo $html;
 }
} else {
