...
<h1>Book a City Taxi to Your Destination in town</h1>
    ...
    <table id="tbl">
        <th>From </th>
        <th>To </th>
        <th>Ride Date <a href="completedRideRecords.php?status=2&sort=ASC&for=ride_date"><i class="fa fa-caret-down" style="color:black" aria-hidden="true"></i>  </a>
        <a href="completedRideRecords.php?status=2&sort=DESC&for=ride_date"><i class="fa fa-caret-up" style="color:black" aria-hidden="true"></i>  </a>
        </th>
        <th>Cab Type</th>
